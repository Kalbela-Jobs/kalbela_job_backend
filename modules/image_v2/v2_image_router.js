...
// const saveStreamToFile = (stream, dir, filename) => {
...
//             await saveStreamToFile(req.file.stream, imageDir, nextFilename);
...
//             await saveStreamToFile(req.file.stream, audioDir, nextFilename);
